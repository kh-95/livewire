...
{{method_field('post')}}
	...
	<input type ="text" class="form-control" name="first_name" value="{{ old('first_name')}}" placeholder="fname">
	<label>{{trans('site.Last_name')}}</label>
	<input type ="text" class="form-control" name="last_name" value="{{ old('last_name')}}" placeholder="lname">
    ...
    <div>
  <img src="{{asset('uploads/users_images/default.png')}}" width="100px" class="img-thumbnail image-preview" alt="">
  </div>
...
<button type ="submit" class="btn btn-primary" name="submit" id="submit" value="submit"><i class="fa fa-plus"></i>Create</button>
